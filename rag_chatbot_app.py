...
def load_llm():
    ...
    with st.spinner("Đang tải mô hình Vicuna..."):
...
def process_pdf(uploaded_file):
    ...
    try:
        ...
        # Tạo vector DB
        vector_db = Chroma.from_documents(docs, embedding=st.session_state.embeddings)
        ...
        # Xoá file tạm để tránh đầy ổ
        os.unlink(tmp_file_path)

MAX_HISTORY = 100  # tuỳ chỉnh
